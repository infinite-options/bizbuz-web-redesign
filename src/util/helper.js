...
const linksByUser = (linksArr, ug, userId) => {
	...
	Object.keys(ug).forEach((uk) => {
		if (
			!["origin", "link_uids", "outward_links", "inward_links"].includes(
				uk
			)
		) {
...
const getCookieParam = (document, param) => {
...
export { MaskCharacter, formatPhoneNumber, transformGraph, getCookieParam };
