...
const EventDashboard = () => {
    ...
    return (
        <Box display="flex" flexDirection="column">
            ...
            <Typography gutterBottom variant="h4" align="center" sx={{ color: '#ffffff' }}>
            ...
            >
                <Stack spacing={5}>
                    ...
                    <Button size="large" color="secondary" variant="contained" onClick={() => navigate("/eventRegistrants", {state: { eventObj, userObj },})}>
                        {"View Registrants"}
                    </Button>
                    <Button size="large" color="secondary" variant="contained">
                        {"View Attendees"}
                    </Button>
                    <Button size="large" color="secondary" variant="contained" onClick={() => navigate("/overallNetwork", {state: { eventObj, userObj },})}>
                        {"View Network"}
                    </Button>
                    <Button size="large" color="secondary" variant="contained">
                        {"Broadcast"}
                ...
                <Button size="large" color="secondary" variant="contained" onClick={() => navigate("/")}>
                    {"Home Page"}
                </Button>
            </Stack>
            <Dialog open={showDialog} onClose={() => setShowDialog(false)}>
                ...
                <Button size="large" color="secondary" variant="contained" onClick={() => setShowDialog(false)}>
                    {"Cancel"}
                </Button>
                </DialogActions>
            </Dialog>
