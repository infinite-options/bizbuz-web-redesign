            ...
            <Box sx={{ display: "flex", flexDirection: "column", mt: 4 }}>
                            ...
                            <CardActionArea>
                                <CardContent>
                                    <Grid container rowSpacing={1}>
                                        <Grid sx={{mt: "-32px", }} item container alignItems="center">
                                            <Phone />
                                            <Grid item xs={6} sx={{ fontWeight: "normal", marginLeft:"8px" }}>
                                            {registrant.phone_number}
                                            </Grid>
                                        </Grid>
                                        <Grid sx={{mt: "8px", }}item container alignItems="center">
                                            <Mail />
                                            <Grid item xs={6} sx={{ fontWeight: "normal", marginLeft:"35px" }}>
                                            {registrant.email}
                                            </Grid>
                                        </Grid>
                ...
                <Grid sx={{mt: "64px", marginBottom: "32px"}}>
                    {qas.map((qa) => (
                        <Box
                            key={qa.id}
                            sx={{ display: "flex", flexDirection: "column", my: 2, mt: "16px" }}
                        >
                            <Typography
                                variant="body1"
                                gutterBottom
                            ...
                            <Grid sx={{mt:"8px"}} container justifyContent="center" alignItems="center">
                                <Card
                                    sx={{
                                        display: "flex",
                                        width: "350px",
                                    ...
                                    <CardActionArea>
                                        <CardContent sx={{ display: "flex", alignItems: "flex-start" }}>
                                            <Typography sx={{ml:"-16px", mt:"-56px"}} variant="body1" gutterBottom>
                                                {qa.answer}
                                            </Typography>
                                        </CardContent>
                                    </CardActionArea>
